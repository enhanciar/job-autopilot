...
export type OpenQuestion = { id: number; text: string; options: string[] | null; companies: string[]; job_ids: number[]; times_seen: number }
...
export const api = {
  ...
  lookAtForm: (qid: number) => req<{ run_id: number }>(`/api/questions/${qid}/look`, { method: 'POST' }),
